 ...
 */
final class Version20191201181438 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE sold sold TINYINT(1) NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE sold sold TINYINT(1) NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
